...
`LICENSE`。（[spec](specs/2026-06-01-open-source-free-pivot.md) ·
[plan](plans/2026-06-01-open-source-free-pivot.md)）

> ⚠️ 因此下方第 1 节里**"上线销售页面 / 定价"相关设想已作废**——产品不再收费。
> 该节的"智能客服"部分若仍要做，需重写为纯产品答疑、去掉销售/定价语境。
