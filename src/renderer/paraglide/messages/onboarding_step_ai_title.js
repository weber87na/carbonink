...
const en_onboarding_step_ai_title = /** @type {(inputs: Onboarding_Step_Ai_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`AI provider`)
};

const zh_cn2_onboarding_step_ai_title = /** @type {(inputs: Onboarding_Step_Ai_TitleInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`AI 提供方`)
};
...
export const onboarding_step_ai_title = /** @type {((inputs?: Onboarding_Step_Ai_TitleInputs, options?: { locale?: "en" | "zh-CN" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Step_Ai_TitleInputs, { locale?: "en" | "zh-CN" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_step_ai_title(inputs)
	return zh_cn2_onboarding_step_ai_title(inputs)
});