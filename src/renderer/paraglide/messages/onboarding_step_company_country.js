...
const en_onboarding_step_company_country = /** @type {(inputs: Onboarding_Step_Company_CountryInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Country`)
};

const zh_cn2_onboarding_step_company_country = /** @type {(inputs: Onboarding_Step_Company_CountryInputs) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`国家`)
};
...
export const onboarding_step_company_country = /** @type {((inputs?: Onboarding_Step_Company_CountryInputs, options?: { locale?: "en" | "zh-CN" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Onboarding_Step_Company_CountryInputs, { locale?: "en" | "zh-CN" }, {}>} */ ((inputs = {}, options = {}) => {
	...
	if (locale === "en") return en_onboarding_step_company_country(inputs)
	return zh_cn2_onboarding_step_company_country(inputs)
});