...
/**
 * Outbound wizard: user uploads a customer/regulator-supplied xlsx
 * questionnaire; the LLM extracts questions; we land the user on the
 * detail page in `mapping` status so they can review the auto-extract
 * + run answer generation.
 *
 * Logic identical to the previous v1 `/questionnaires/new` wizard.
 * Moved here as part of the v2.0 entry-point split (the new
 * `/questionnaires/new` is now a direction chooser).
 */
export const Route = createFileRoute('/questionnaires/new/outbound')({
  component: NewOutboundQuestionnaireRoute,
});

const XLSX_MIME = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';

function NewOutboundQuestionnaireRoute(): JSX.Element {
