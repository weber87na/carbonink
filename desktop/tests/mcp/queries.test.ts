...
// ---------------------------------------------------------------------------
// Write tests deliberately absent: the write functions were removed from this
// module (spec 2026-08-13-mcp-write-path-integrity). Writes now dispatch over
// the agent bridge into the app's IPC handlers and are covered by
// tests/main/agent-bridge/ instead.
// ---------------------------------------------------------------------------
// ---------------------------------------------------------------------------
