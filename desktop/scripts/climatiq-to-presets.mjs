...
const CATEGORY_TO_SCOPE = {
  ...
  Fuel: 1,
  'Fuels and Fugitives': 1,
  Fugitives: 1,
  'Refrigerants and Fugitives': 1,
  'Refrigerants and Heat Transfer Fluids': 1,
  ...
  Cooling: 2,
  // ── Scope 3 — everything else we ship
  'Air Travel': 3,
  'Ground Travel': 3,
  'Sea Travel': 3,
  'Business Travel': 3,
  ...
  'Road Freight': 3,
  'Rail Freight': 3,
  'Inland Waterways Freight': 3,
  Freight: 3,
  Transport: 3,
  'Transportation Services': 3,
  Accommodation: 3,
  Restaurants: 3,
  'Restaurants and Accommodation': 3,
  Office: 3,
  'Office Equipment': 3,
  'IT Hardware': 3,
  'IT and Telecommunication Services': 3,
  ...
  Insurance: 3,
  'Real Estate': 3,
  'Professional Services and Activities': 3,
  Education: 3,
  Healthcare: 3,
  Government: 3,
